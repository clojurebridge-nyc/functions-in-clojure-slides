...
////
Exercise: some kind of complex operation
Exercise: navigate into a map
////
...
== (Bonus) Parameter lists and arity
...
- using `(require)` from the command-line
- Note on quoting vector
- :as, :refer
...
== (Advanced) more about `(map)`

- Map keyword over list of maps
...
- The problem: deeply-nested expressions
- Solving this problem using let
- Using the arrow macro to simplify
- The two flavors and when they're used (map, filter)
- Arrow functions to navigate into data
